    ...
    segments: [
      {
        ...
        coords: [
          [14.4694, 120.9768], // SM Bacoor
          [14.4500, 120.9780], // Talaba
          [14.4720, 120.9830], // Zapote
          [14.5010, 120.9877], // Las Piñas
          [14.5132, 120.9941], // Baclaran
          [14.5350, 120.9830], // PITX / Taft Ave
          [14.5500, 120.9850], // Taft northbound
          [14.5700, 120.9900], // Vito Cruz
          [14.5876, 120.9930], // Pedro Gil
          [14.6010, 120.9870], // UN Ave approach
          [14.6099, 120.9893], // España / UST
        ],
      },
      {
        segmentOrder: 2,
    ...
    segments: [
      {
        ...
        coords: [
          ...
          [14.5010, 120.9877], // Las Piñas
          [14.5132, 120.9941], // Baclaran
          [14.5387, 120.9942], // Taft / Pasay
          [14.5700, 120.9900], // Vito Cruz
          [14.5876, 120.9930], // Pedro Gil
          [14.5940, 120.9840], // Intramuros area
          [14.5940, 120.9787], // Lawton / Manila City Hall
        ],
      },
      {
        segmentOrder: 2,
        ...
        coords: [
          [14.5940, 120.9787], // Lawton
          [14.5990, 120.9790], // Quiapo direction
          [14.6060, 120.9870], // España approach
          [14.6099, 120.9893], // UST
        ],
      },
      {
        segmentOrder: 3,
...

  {
    ...
    segments: [
      ...
      },
      {
        ...
        coords: [
          [14.5132, 120.9941], // Baclaran
          [14.5300, 120.9942], // EDSA
          [14.5387, 120.9942], // Taft / Gil Puyat
          [14.5629, 120.9951], // Vito Cruz
          [14.5768, 120.9938], // Quirino
          [14.5876, 120.9961], // Pedro Gil
          [14.5960, 120.9885], // Central
          [14.5998, 120.9821], // UN Ave
          [14.6081, 120.9841], // Doroteo Jose / Recto
        ],
      },
      {
        segmentOrder: 3,
        ...
        coords: [
          [14.6081, 120.9841], // Recto
          [14.6130, 120.9860], // Legarda
        ],
      },
      {
        segmentOrder: 4,
    ...
    segments: [
      {
        ...
        coords: [
          ...
          [14.5010, 120.9877], // Las Piñas
          [14.5132, 120.9941], // Baclaran
          [14.5300, 120.9942], // EDSA / Taft
          [14.5387, 120.9942], // Pasay / Taft Ave
        ],
      },
      {
        segmentOrder: 2,
        ...
        coords: [
          [14.5387, 120.9942], // EDSA / Taft
          [14.5629, 120.9951], // Vito Cruz
          [14.5768, 120.9938], // Quirino
          [14.5876, 120.9961], // Pedro Gil
          [14.5960, 120.9885], // Central
          [14.5998, 120.9821], // UN Ave
          [14.6081, 120.9841], // Doroteo Jose
        ],
      },
      {
        segmentOrder: 3,
...

  {
    ...
    segments: [
      ...
      },
      {
        ...
        coords: [
          [14.5940, 120.9787], // Lawton
          [14.5960, 120.9810], // Padre Faura
          [14.5998, 120.9821], // UN Ave / Quirino
        ],
      },
      {
        segmentOrder: 3,
        ...
        coords: [
          [14.5998, 120.9821], // UN Ave
          [14.6040, 120.9860], // España approach
          [14.6060, 120.9870], // Legarda
          [14.6041, 120.9923], // NU Manila
        ],
      },
    ],
  },
...
// crowd status data — will be real-time from DB later
